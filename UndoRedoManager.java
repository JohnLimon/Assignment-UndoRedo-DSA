...
public class UndoRedoManager<T> {
    private class Node {
        private final T state; // Make the state final
        private Node prev;
        private Node next;
    ...
    public static void main(String[] args) {
        ...
        String undoneState = undoRedoManager.undo();
        if (undoneState != null) {
            System.out.println("Undone to state: " + undoneState);
        }

        undoneState = undoRedoManager.undo();
        if (undoneState != null) {
            System.out.println("Undone to state: " + undoneState);
        }
        ...
        String redoneState = undoRedoManager.redo();
        if (redoneState != null) {
            System.out.println("Redone to state: " + redoneState);
        }

        redoneState = undoRedoManager.redo();
        if (redoneState != null) {
            System.out.println("Redone to state: " + redoneState);
        }
    }
